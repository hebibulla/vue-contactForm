...
<body>
    ...
    <div class="mailer-config mb-5 border-bottom">
        <div class="wrapper">
            <div class="form-group">
                <label for="host">host</label>
                <input type="text" v-model="param.host_address" id="host" class="form-control" placeholder="host address">
            </div>
            <div class="form-group">
                <label for="host">User name</label>
                <input type="text" v-model="param.user_name"  id="userName" class="form-control" placeholder="user name">
            </div>
            <div class="form-group">
                <label for="host">password</label>
                <input type="password" v-model="param.password"  id="password" class="form-control" placeholder="password">
            </div>
            <div class="form-group">
                <label for="host">set from</label>
                <input type="text" v-model="param.set_from"  id="setFrom" class="form-control" placeholder="set from">
            </div>
            <div class="form-group">
                <label for="host">add replay</label>
                <input type="text" v-model="param.add_replay"  id="addReplay" class="form-control" placeholder="add replay">
            </div>
        
            <!-- <button type="button" @clik="done()" class="btn btn-primary w-100">確定(done)</button> -->
        </div>
    </div>
        <div class="wrapper">
            ...
            <div class="" v-if="!contact_sent">
                ...
                <div class="form-group">
                    <label for="name1"><i class="text-danger">&lowast;</i>お名前</label>
                ...
                <div class="form-group has-success has-feedback">
                    <label for="nam2"><i class="text-danger">&lowast;</i> お名前(よみがな)</label>
                    ...
                    v-bind:disabled="input_checker"
                    type="text" class="form-control" id="name2" placeholder="よみがなを入力してください">
                </div>
                <label class="" for="email"> <i class="text-danger">&lowast;</i>メールアドレス</label>
                <div class="form-row form-group">
                    <div class="col-lg-7 col-12">
                        ...
                        v-bind:disabled="input_checker"
                        type="email" class="form-control" id="email" placeholder="メールアドレスを入力してください" required>
                    </div>
        ...
        const app = new Vue({
            ...
            methods: {
                ...
                reset:function(){
                    ...
                    $cookies.remove("contact_sent","/contact");
                ...
                sendPass:function(){
                    ...
                    sendPassApi.post('contact/mail.php',JSON.stringify(
                            this.param
                        ))
                        .then((response)=>{
                ...
                postData:function(){
                    ...
                    axiosApi.post('contact/mail.php',JSON.stringify(this.param))
                        .then((response) => {
                            if(response.data == 'success'){
                                //koocie をゲット
                                this.spinner = false;
