...
if(!isset($_SESSION['csrf_token'])){
    ...
    if($data['token'] === $_SESSION['csrf_token'] ){
        ...
        if(isset($data['code'])){
            ...
            $set_from = $data['set_from'];
            $replay_to = $data['add_replay'];
            ...
            try {
                ...
                //Recipients
                $mail->setFrom($set_from,'your server name');
                $mail->addAddress($email,'pass code');     // Add a recipient
                $mail->addReplyTo($replay_to,'your server name');
        ...
        try {
            ...
            //Recipients
            $mail->setFrom($set_from,'name');
            $mail->addAddress($email,'contact');     // Add a recipient
            $mail->addReplyTo($replay_to,'name');
            // $mail->addCC('cc@example.com');
            // $mail->addBCC('bcc@example.com');
